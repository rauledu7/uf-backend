...
const corsConfig: CorsConfig = {
  ...
  */
  ...
  |
  */
  origin: Env.get('NODE_ENV') === 'development' ? true : ['https://dev.ultimatefitness.cl', 'https://new.ultimatefitness.cl', 'https://www.postman.com', 'https://ultimatefitness.cl','https://ultimatefitness.com.co','https://ultimatefitness.pe','https://dev.ultimatefitness.com.co','https://dev.ultimatefitness.pe'],

  // origin: ['https://dev.ultimatefitness.cl', 'https://new.ultimatefitness.cl', 'https://www.postman.com', 'https://ultimatefitness.cl'],
