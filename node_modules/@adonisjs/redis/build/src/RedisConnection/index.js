 ...
 * by itself.
 */
class RedisConnection extends AbstractConnection_1.AbstractConnection {
    constructor(connectionName, config, application) {
        super(connectionName, application);
        this.config = this.normalizeConfig(config);
        this.ioConnection = new ioredis_1.default(this.config);
    ...
    makeSubscriberConnection() {
        this.ioSubscriberConnection = new ioredis_1.default(this.config);
    }
}
